...
python generate_glossary.py ^
	...
	--projectiles ^
	"C:\Program Files (x86)\Steam\steamapps\workshop\content\32470\2794270450\Data\Xml\PROJECTILES.XML" ^
	--output index.html ^
	--images-dir png_images ^
	--translations ^
	"C:\Program Files (x86)\Steam\steamapps\workshop\content\32470\2794270450\Data\Text\xml\TranslationManifest.xml" ^
	--image-size 100 ^
	...
	--mod-icon "faction_images\EAWCWHSteam.png" ^
